 ...
 * @author asus-pc
 */
public class BadgeAndTicketClaimUI extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public BadgeAndTicketClaimUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        label1.setText("Search Payid: ");

        jButton1.setText("Submit");

        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"P1003", "2135", "1124,1000,1212", "Mug", "11/14/2014 Claimed"},
                {"P1234", "1009", "1250", "T-shirt, Mug", ""},
                {"P1240", "3103", "2500,1112", "Mug", "11/15/2014 Claimed"},
                {"P1500", "1111", "5260,1000,3001", "T-shirt, Mug, CD w/ autograph", null}
            },
            new String [] {
                "Pay id", "Badge id", "Ticket No.", "Freebies", "Date Claimed"
            }
        ) {
        ...
        jLabel2.setText("Claim");

        jLabel3.setText("Claim");

        jButton3.setText("Claim");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BadgeAndTicketClaimUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BadgeAndTicketClaimUI().setVisible(true);
            }
        });
    }
