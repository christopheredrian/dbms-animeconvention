...
/**
 *
 * @author Crimson_reapeR
 */
public class TicketMonitoring extends javax.swing.JFrame {

    /**
     * Creates new form NewJFrame
     */
    public TicketMonitoring() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jXSearchField1.setToolTipText("Search ticket number");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TicketMonitoring.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TicketMonitoring().setVisible(true);
            }
        });
    }
